...
var OmicronLab={Avro:{}};
OmicronLab.Avro.Phonetic={parse:function(a){for(var a=this.fixString(a),f="",c=0;c<a.length;++c){for(var e=c,g=c+1,h=e-1,k=!1,h=0;h<this.data.patterns.length;++h){var i=this.data.patterns[h],g=c+i.f.length;if(g<=a.length&&a.substring(e,g)==i.f){h=e-1;if(tof i.u!=="undefined")for(var l=0;l<i.u.length;++l){for(var m=i.u[l],j=!0,d=0,n=0;n<m.m.length;++n){var b=m.m[n],d=b.t==="s"?g:h;if(tof b.negative==="undefined"&&(b.negative=!1,b.s.charAt(0)==="!"))b.negative=
!0,b.s=b.s.substring(1);if(tof b.v==="undefined")b.v="";if(b.s==="p"){if(!(d<0&&b.t==="p"||d>=a.length&&b.t==="s"||this.isPunctuation(a.charAt(d)))^b.negative){j=!1;break}}else if(b.s==="vowel"){if(!((d>=0&&b.t==="p"||d<a.length&&b.t==="s")&&this.isVowel(a.charAt(d)))^b.negative){j=!1;break}}else if(b.s==="c"){if(!((d>=0&&b.t==="p"||d<a.length&&b.t==="s")&&this.isConsonant(a.charAt(d)))^b.negative){j=
